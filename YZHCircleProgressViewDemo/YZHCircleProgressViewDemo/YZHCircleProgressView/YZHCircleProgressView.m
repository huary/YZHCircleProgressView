...
-(void)setUpChild
{
    self.circleType = CircleProgressViewTypeDefaultOnce;
...
{
    if (self.circleType == CircleProgressViewTypeDefaultOnce) {
    ...
    else if (self.circleType == CircleProgressViewTypeInfinitePartRadian)
    {
        [self setProgressPathWithProgress:progress];
    ...
    else if (self.circleType == CircleProgressViewTypeInfiniteAllRadian)
    {
        [self setProgressPathWithProgress:progress];
...
//        groupAnimation.timingFunction = [CAMediaTimingFunction functionWithName:@"easeInEaseOut"];
